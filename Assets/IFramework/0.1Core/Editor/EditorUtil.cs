...
namespace IFramework
{
    class EditorUtil
	{
        ...
        {
            OpenFloder("Document", Application.persistentDataPath, "doc");
        }
        [MenuItem(openStreamingPath)]
        public static void OpenStreaming()
        {
            OpenFloder("Streaming", Application.streamingAssetsPath, "stream");
        }
        [MenuItem(openDataPath)]
        public static void OpenDataPath()
        {
            OpenFloder("DataPath", Application.dataPath, "data");
        }
#if UNITY_2018
        [MenuItem(openConsoleLogPath)]
        public static void OpenConsoleLog()
        {
            OpenFloder("ConsoleLog", Application.consoleLogPath, "console");
        }
#endif
        [MenuItem(openTemporaryCachePath)]
        public static void OpenTemporary()
        {
            OpenFloder("Temporary", Application.temporaryCachePath, "temporary");
        }
        ...
        public static void OpenFloder(string title, string folder, string defaultName)
        {
