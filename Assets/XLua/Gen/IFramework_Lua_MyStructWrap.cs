...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkLuaMyStructWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Lua.MyStruct);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					...
					IFramework.Lua.MyStruct gen_ret = new IFramework.Lua.MyStruct(_p1, _p2);
					translator.PushIFrameworkLuaMyStruct(L, gen_ret);
				...
				{
				    translator.PushIFrameworkLuaMyStruct(L, default(IFramework.Lua.MyStruct));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Lua.MyStruct constructor!");
        ...
        static int _g_get_a(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Lua.MyStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _g_get_e(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Lua.MyStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushIFrameworkLuaPedding(L, gen_to_be_invoked.e);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_a(RealStatePtr L)
        {
		    try {
                ...
                translator.UpdateIFrameworkLuaMyStruct(L, 1, gen_to_be_invoked);
        ...
        static int _s_set_e(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Lua.MyStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                IFramework.Lua.Pedding gen_value;translator.Get(L, 2, out gen_value);
