...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkLuaNoGcWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Lua.NoGc);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					IFramework.Lua.NoGc gen_ret = new IFramework.Lua.NoGc();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Lua.NoGc constructor!");
        ...
        static int _m_StructParamMethod(RealStatePtr L)
        {
		    try {
                ...
                {
                    IFramework.Lua.MyStruct _p;translator.Get(L, 2, out _p);
                    
                        IFramework.Lua.MyStruct gen_ret = gen_to_be_invoked.StructParamMethod( _p );
        ...
        static int _s_set_a3(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Lua.NoGc gen_to_be_invoked = (IFramework.Lua.NoGc)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a3 = (IFramework.Lua.MyStruct[])translator.GetObject(L, 2, typeof(IFramework.Lua.MyStruct[]));
        ...
        static int _s_set_a4(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Lua.NoGc gen_to_be_invoked = (IFramework.Lua.NoGc)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a4 = (IFramework.Lua.MyEnum[])translator.GetObject(L, 2, typeof(IFramework.Lua.MyEnum[]));
