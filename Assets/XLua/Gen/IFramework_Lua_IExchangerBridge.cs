...
{
    public class IFrameworkLuaIExchangerBridge : LuaBase, IFramework.Lua.IExchanger
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new IFrameworkLuaIExchangerBridge(reference, luaenv);
		}
		
		public IFrameworkLuaIExchangerBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
