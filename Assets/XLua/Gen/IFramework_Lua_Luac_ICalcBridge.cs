...
{
    public class IFrameworkLuaLuacICalcBridge : LuaBase, IFramework.Lua.Luac.ICalc
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new IFrameworkLuaLuacICalcBridge(reference, luaenv);
		}
		
		public IFrameworkLuaLuacICalcBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int IFramework.Lua.Luac.ICalc.Add(int a, int b)
		{
        ...
        int IFramework.Lua.Luac.ICalc.Mult 
        {
		...
		event System.EventHandler<IFramework.Lua.Luac.PropertyChangedEventArgs> IFramework.Lua.Luac.ICalc.PropertyChanged
		{
			add
			{
#if THREAD_SAFE || HOTFIX_ENABLE
