...
namespace XLua
{
    ...
    public partial class StaticLuaCallbacks
    {
        ...
        [MonoPInvokeCallback(typeof(LuaDLL.CSharpWrGameerCaller))]
        internal static int CSharpWrGameerCallerImpl(RealStatePtr L, int funcidx, int top)
        {
            try
            {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
                return translator.CallCSharpWrGameer(L, funcidx, top);
            }
            catch (Exception e)
            {
