...
namespace XLua
{
    internal partial class InternalGlobals
    {
        ...
        internal static volatile LuaDLL.CSharpWrGameerCaller CSharpWrGameerCallerPtr = new LuaDLL.CSharpWrGameerCaller(StaticLuaCallbacks.CSharpWrGameerCallerImpl);
#endif
